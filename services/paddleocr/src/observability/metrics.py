...
recognition_requests_total = Counter(
    "paddleocr_recognition_requests_total",
    "total number of recognition requests",
    ["status"],
)

recognition_errors_total = Counter(
    "paddleocr_recognition_errors_total",
...
active_recognitions = Gauge(
    "paddleocr_active_recognitions", "number of currently active recognition requests"
)
